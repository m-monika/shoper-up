...
4. Zmień konfigurację tak, aby `title`, `description`, `buttonLabel` oraz `url` można było [tłumaczyć](https://storefront.developers.shoper.pl/sve/configuration/#supportstranslations) dla różnych języków (w SVE zmieniając język).
