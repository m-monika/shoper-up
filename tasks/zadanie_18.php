...
do {
    $basketVal += $price;
    echo "Produkt dodany do koszyka. Aktualna suma koszyka: " . $basketVal . " zł" . "\n";
} while ($basketVal < $freeDeliveryThreshold);

echo "Osiągnięto darmową wysyłkę. Łączna wartość zamówienia: " . $basketVal . " zł";