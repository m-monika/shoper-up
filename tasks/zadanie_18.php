...
do {
    $basket = $basket + $price;
    echo "Produkt dodany do koszyka. Aktualna suma koszyka: ".$basket." zł\n";
} while ($basket < $freeDeliveryThreshold);

echo "Osiągnięto darmową wysyłkę. Łączna wartość zamówienia: ".$basket." zł";