...
$gross = ($shirt * $shirtCount) + ($hat * $hatCount) + ($gloves * $glovesCount);   // TODO
$net =  ($shirt / (1 + $shirtVat / 100) * $shirtCount) + 
        ($hat / (1 + $hatVat / 100) * $hatCount) + 
        ($gloves / (1 + $glovesVat / 100) * $glovesCount);// TODO
